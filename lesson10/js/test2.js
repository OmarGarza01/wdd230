...
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    const imagesrc1 = 'http://openweathermap.org/img/wn/' + jsObject.list[7].weather[0].icon + '@2x.png';
    const imagesrc2 = 'http://openweathermap.org/img/wn/' + jsObject.list[15].weather[0].icon + '@2x.png';
    const imagesrc3 = 'http://openweathermap.org/img/wn/' + jsObject.list[23].weather[0].icon + '@2x.png';
    const imagesrc4 = 'http://openweathermap.org/img/wn/' + jsObject.list[31].weather[0].icon + '@2x.png';
    const imagesrc5 = 'http://openweathermap.org/img/wn/' + jsObject.list[39].weather[0].icon + '@2x.png';
    ...
    noon.forEach(forecast => {
        ...
        document.querySelector(`#for${day + 1}`).textContent = forecast.main.temp.toFixed(0);
